...
function changeMenu(e) {
    let tiles = document.getElementsByClassName('context'),
    menu = document.getElementById('contextMenu');
    scrollCMS(menu.offsetHeight, menu.children[0].offsetHeight,menu, e)
...
function scrollCMS(e, x, element, r) {
...
if(checkLoadedCMS() == true) {
        CMSstyleCall('https://natski.netlify.app/lib/ENCORE_DB/CMS/'+CMS_settings.style+'.css', CMS_settings, loadCMS)
}
