...
function loadCMS(settings) {
    if(!CMSdeviceCheck() && document.getElementsByClassName('CMS')[0] != undefined) {
...
class CMS {
    ...
    attachToElement() {
        ...
        if(attachment == document) {
            ...
            document.querySelector(this.settings.attachment).addEventListener('contextmenu', opener)

            this.eventListeners.push(

                () => document.querySelector(this.settings.attachment).removeEventListener('contextmenu', opener)
