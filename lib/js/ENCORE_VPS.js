...
function VPSstyleCall(url,load) {
    ...
    style.type = "text/css"
    if(!deviceCheck()){
        style.href = 'https://natski.netlify.app/lib/ENCORE_DB/VPS/' + url + 'mobile.css'
    }else{
        style.href = 'https://natski.netlify.app/lib/ENCORE_DB/VPS/' + url + '.css'
    }
...
if(checkLoadedVPS() == true) {
    VPSstyleCall(VPS_settings.style, loadVPS)
}
