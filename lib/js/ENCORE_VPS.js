...
function fullScreen(e) {
    ...
    if(document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement){
        ...
        } else if (document.getElementsByClassName('VPScontainer')[e].webkitEnterFullscreen) {
            document.getElementsByClassName('VPScontainer')[e].webkitEnterFullscreen();
        }
...
function addVPSfuntions(e) {
    ...
    proginput.oninput = function(){adjustBar(e,proginput.value);videoTime(e,proginput.value);currentVideoTime(e)}
    ...
    container.onmouseleave = function(){hideCont(e);closeVolume(e)}
}
