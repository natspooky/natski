...
function checkVPSsettings(e, device) {
    if(VPS_settings.autoplay){
        document.getElementsByClassName('VPS')[e].setAttribute('autoplay','')
        document.getElementsByClassName('VPS')[e].setAttribute('muted','')
        if(!device){
            adjustVolume(e,0)
        }
        playVPS(e)
...
function addVPSfuntions(e,device) {
    ...
    if(!device){
        ...
        proginput.ontouchend = function(){overlayDisplay(e)}
    }
