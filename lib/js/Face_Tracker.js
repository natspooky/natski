...
class calibrator extends VideoProcessor {
  ...
  while(super.getPosition(this.frame).length < 4){
...
function startCalibrate() {
  ...
  for(let i = 0; i < 3; i++) {
    ...
    console.log(trackerSettings.Threshold[i])
    document.getElementById(`Threshold${i+1}`).value = (125/trackerSettings.Threshold[i])
  }
}
