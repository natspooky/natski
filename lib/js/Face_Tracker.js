...
function drawLines(){
    ...
    ctx.arc(center.x, center.y,
      Math.max(Math.sqrt((center.x - cameraPoints.green.x)**2 + (center.y - cameraPoints.green.y)**2),Math.sqrt((center.x - cameraPoints.red.x)**2 + (center.y - cameraPoints.red.y)**2),Math.sqrt((center.x - cameraPoints.blue.x)**2 + (center.y - cameraPoints.blue.y)**2)),
      0,Math.PI*2);
...
xt = 0//( (canvas.height / 2 - (center.x - cameraPoints.green.x)) / canvas.height),
yt = 0//( (canvas.width / 2 - (center.y - cameraPoints.green.y)) / canvas.width)
