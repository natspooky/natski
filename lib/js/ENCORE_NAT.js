...
function colourSystemBeta(e) {  
    for (let t = 0; t < e.length; t++) {
        let a, o, c, s, l = document.createElement("canvas"), r = l.getContext && l.getContext("2d"), n = {r: 0, g: 0, b: 0}, i = 0;
        ...
        for (let g = 0; g < s; g += 4) n.r += a.data[g], n.g += a.data[g + 1], n.b += a.data[g + 2], i++;
