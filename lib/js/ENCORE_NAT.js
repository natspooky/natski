...
function themeSystem(e){
    colourbg.style.backgroundImage = "radial-gradient(farthest-side at top left,"+e+" 0.4), transparent),radial-gradient(farthest-corner at top right, "+e+" 0.3), transparent 400px)"
