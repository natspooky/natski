...
function NATredirectPopup() {
    ...
    openbtn.onclick = function(){
        if(window.location.href.slice(window.location.href.length - 4, window.location.href.length) == 'html'){
            window.open('https://natski.netlify.app/index.html#' + window.location.href.slice(27, window.location.href.length - 5))
        }else{
            window.open('https://natski.netlify.app/index.html#' + window.location.href.slice(27, window.location.href.length))
        }
    }
