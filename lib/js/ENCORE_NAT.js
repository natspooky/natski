...
function themeSystem(e){
    colourbg.style.backgroundImage = "radial-gradient(circle farthest-side at top left,"+e+" 0.4), transparent), radial-gradient(circle farthest-side at bottom right,"+e+" 0.1), transparent)"
