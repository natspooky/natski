...
function themeSystem(e){
    colourbg.style.backgroundImage = "radial-gradient(circle farthest-side at top left,"+e+" 0.4), transparent),radial-gradient(circle farthest-corner at top right, "+e+" 0.3), transparent 300px)"
