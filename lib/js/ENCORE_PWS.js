...
function PWScssLoader() {
    if(deviceCheckPWS()){
        PWSstyleCall('https://natski.netlify.app/lib/ENCORE_DB/PWS/'+PWS_settings.style+'mobile.css', loadPWS)
    }else{
        PWSstyleCall('https://natski.netlify.app/lib/ENCORE_DB/PWS/'+PWS_settings.style+'.css', loadPWS)
    }
}
