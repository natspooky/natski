...
function drawhead() {
  ...
  ctx.quadraticCurveTo(-0.4, 0.5,leftAnchor.x,leftAnchor.y);
  ctx.quadraticCurveTo(-0.45, -0.55,topAnchor.x,topAnchor.y);
  ctx.quadraticCurveTo(0.45, -0.55,rightAnchor.x,rightAnchor.y);
...
function getPointCamera(videoframe,color=[0,0,255],amount=155){
  const location = [];
