...
function inspectLoadPDS(path) {
    ...
    inspectimage.onload = function() {
        ...
        let windowTop = (inspectPanel.offsetHeight / 2) - inspectimage.offsetHeight / 2,
        windowLeft = (inspectPanel.offsetWidth / 2) - inspectimage.offsetWidth / 2
...
function inspectLoadInitialPDS(path, speificimage) {
    ...
    inspectimage.onload = function() {
        ...
        animationStart(inspectimage, speificimage, left, top, playAnimation)
...
function animationStart(inspectimage, speificimage, left, top, playAnimation){


    inspectimage.style.transform = 'translate('+ left +'px,'+ top +'px) scale('+  speificimage.offsetHeight / inspectimage.offsetHeight +')'

    let windowTop = (window.innerHeight / 2) - inspectimage.offsetHeight / 2,
    windowLeft = (window.innerWidth / 2) - inspectimage.offsetWidth / 2

    playAnimation(inspectimage, windowLeft, windowTop)
}


function playAnimation(inspectimage, windowLeft, windowTop){
    inspectimage.style.opacity = '1'
    inspectimage.style.transition = '0.4s ease, background-color 0s, opacity 0.1s'
    inspectimage.style.transform = 'translate('+ windowLeft +'px,'+ windowTop +'px) scale(1)'
}
