...
function createGalleryPDS(settings,PDS){
    ...
    // change to make work (four indevidual columns of 50% width and INLINE)
    ...
    createImagesOverflowPDS(settings, values)
}
...
function createImagesOverflowPDS(settings,values) {
