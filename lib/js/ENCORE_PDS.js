...
function loadPDS(settings) {
    ...
    closer.onclick = function() {document.getElementById('PDSinspectPanel').classList.remove('active');document.getElementById('PDSloader').style.display = 'none';document.body.style.overflow = 'unset';document.body.style.height = 'unset'}
