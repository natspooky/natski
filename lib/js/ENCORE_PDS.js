...
function inspectLoad(path) {
    ...
    inspectcont = document.getElementById('inspectContainer')
    ...
    console.log(inspectimage.clientWidth, window.innerWidth)
    if(inspectimage.clientWidth > window.innerWidth){
        inspectimage.width = '100%'
        inspectimage.height = 'unset'
        inspectcont.width = '90%'
        inspectcont.height = 'unset'
    }else{
        inspectimage.width = 'unset'
        inspectimage.height = '100%'
        inspectcont.width = 'unset'
        inspectcont.height = '90%'
    }
