...
function inspectLoadPDS(path) {
    document.getElementById('PDSloader').display = 'block'
    ...
    inspectimage.onload = function() {
        document.getElementById('PDSloader').display = 'none'
...
function loadMiniImagesPDS(settings,currentimage) {
    ...
    if(settings.controls) {
        document.getElementById('PDScounter').innerHTML = PDSimageIndex + ' / ' + PDS_settings.fileCount
