...
function inspectTarget(path, indicator, speificimage) {
    ...
    inspectLoad(path,speificimage)





    var viewportOffset = speificimage.getBoundingClientRect();
    var top = viewportOffset.top;
    var left = viewportOffset.left;
    var textelem = document.getElementById('inspectImage')
    textelem.style.transition ='0s'
    textelem.style.top = top+speificimage.offsetHeight/2+'px'
    textelem.style.left = left+speificimage.offsetWidth/2+'px'
...
function inspectLoad(path,speificimage) {
    ...
    inspectimage.onload = function() {
        ...
        var textelem = document.getElementById('inspectImage')
        textelem.style.height =speificimage.offsetHeight+'px'
    textelem.style.width=speificimage.offsetWidth+'px'
    textelem.style.transition ='0.5s'
    textelem.style.top ='50%'
    textelem.style.left='50%'
    textelem.style.height =null
    textelem.style.width=null
