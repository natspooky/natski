...
let GISVALUES = ['home','terminal','avatar','marker','gear','puzzle','pause','play','prev','next','browser','chain','bookshelf','cellar','apps','rotate','albums','scanner','maximise','minimise','audio','copy','undo','redo','loop','pip','screen','cast','text','battery_empty','battery_half','battery_full','magnify_minus','magnify_plus','magnify','denied','alert','information','circle_minus','circle_plus','circle_checkmark','circle_cross','point','minus','plus','checkmark','cross','crosshair','arrow_left','arrow_right','arrow_up','arrow_down','mini_arrow_left','mini_arrow_right','mini_arrow_up','mini_arrow_down','line_arrow_left','line_arrow_right','line_arrow_up','line_arrow_down','input','output','download','upload','sparkle','config','preview','hidden','ENCORE','SSC','PDS','CLS','CLSF','VPS','PSS','CMS','CMSF','GIS','SSM','SSMF'],
GISRANDOM = []
function loadGIS(){
