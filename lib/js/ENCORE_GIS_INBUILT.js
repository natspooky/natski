...
let GISVALUES = ['home','terminal','avatar','gear','alert','browser','chain','bookshelf','cellar','rotate','albums','maximise','minimise','pause','play','prev','next','audio','copy','information','loop','pip','screen','magnify_minus','magnify_plus','magnify','circle_minus','circle_plus','circle_checkmark','circle_cross','minus','plus','checkmark','cross','arrow_left','arrow_right','arrow_up','arrow_down','mini_arrow_left','mini_arrow_right','mini_arrow_up','mini_arrow_down','line_arrow_left','line_arrow_right','line_arrow_up','line_arrow_down','input','output','download','upload','sparkle','config','preview','hidden','ENCORE','SSC','PDS','CLS','CLSF','VPS','PSS','CMS','CMSF','GIS','SSM','SSMF'],
GISRANDOM = []
function loadGIS(){
