...
function PDSUcssLoader() {
    if(PDSUdevice){
        PDSUstyleCall('https://natski.netlify.app/lib/ENCORE_DB/PDSU/'+PDSU_settings.style+'PDSUmobile.css', PDSU_settings, loadPDSU)
    }else{
        PDSUstyleCall('https://natski.netlify.app/lib/ENCORE_DB/PDSU/'+PDSU_settings.style+'PDSU.css', PDSU_settings, loadPDSU)
    }
}
