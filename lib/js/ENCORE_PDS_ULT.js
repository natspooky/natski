...
let PDSUdevice = PDSUdeviceCheck();
...
function inspectChange(settings, indicator) {
    ...
    loadMiniImages(settings,PDSUimageIndex)
    inspectLoad(settings)
}
...
function loadPDSU(settings) {
    ...
    closer.onclick = function() {document.getElementById('PDSUinspectPanel').classList.remove('active')}
