...
function animationStartPDSU(inspectimage, specificimage, left, top, playAnimationPDSU){
    ...
    inspectimage.style.transform = `translate(${left + ((specificimage.offsetWidth - contained[0]) / 2)}px,${top + ((specificimage.offsetHeight - contained[1]) / 2)}px) scale(${specificimage.offsetHeight / inspectimage.offsetHeight}) rotate(0deg)`
