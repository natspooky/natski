...
function loadPDSU(settings) {
    ...
    closer.onclick = function() {document.getElementById('PDSUinspectPanel').classList.remove('active');document.getElementById('PDSUloader').style.display = 'none';document.body.style.overflow = 'unset';document.body.style.height = 'unset'}
