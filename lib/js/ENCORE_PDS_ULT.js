...
function animationStartPDSU(inspectimage, specificimage, left, top, playAnimationPDSU){
    inspectimage.style.transform = `translate(${left}px,${top}px) scale(${specificimage.offsetHeight / inspectimage.offsetHeight})`
...
function loadPDSU(settings) {
    ...
    page = [-1,1,-0.25,0.25],
    titles = ['Previous','Next','Zoom Out','Zoom In','Rotate']
