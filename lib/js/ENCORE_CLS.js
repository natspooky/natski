...
function CLScreateObserver(){
    let observerMutCLS = new MutationObserver(checkImageCLS),
...
function checkImageCLS(mutations) {
...
function checkChildrenCLS(element) {
    if(element.tagName == 'IMG') {
        ...
        checkChildrenCLS(element.childNodes)
    }
}
