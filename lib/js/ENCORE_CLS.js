...
const logger = function() {
    ...
    systemCount = 0
    if((CLS.offsetTop - CLS.scrollTop + CLS.clientTop) < article.offsetHeight){
        console.log('true')
    }
    if(article.offsetHeight < window.innerHeight && CLS_settings.fileCount > 0 && document.getElementsByClassName('CLSlog').length <= 1 && (CLS.offsetTop - CLS.scrollTop + CLS.clientTop) < article.offsetHeight) {
