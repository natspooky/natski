...
function popupSystemSSM(e,popup){
    ...
    if(!e.parentNode.classList.contains('SSMcategory')){
        popup.style.transform = `translateY(${e.parentNode.parentNode.parentNode.offsetTop + e.parentNode.parentNode.offsetTop + /*e.parentNode.offsetTop +*/ e.parentNode.offsetHeight + 5}px)`
    }else{
        popup.style.transform = `translateY(${e.parentNode.parentNode.offsetTop + e.parentNode.offsetTop + e.parentNode.offsetHeight + 5}px)`
    }
