...
window.addEventListener("load", function() {
    ...
    slideShowElements(SSC_settings)
...
function progressBar() {
    ...
    interval = setInterval(function e() {
        width >= 100 ? clearInterval(interval) : (width++, document.getElementById("progress-bar").style.width = width + "%") 
    }, 100)
}
...
function slideShowElements(settings) {
    ...
    if(settings[1] != 'progressBar:true'){
    ...
    if(settings[2] == 'sideButtons:true'){
        page = ['-1','1']
