$(document).ready(function() {
    window.location !== window.parent.location ? ($("#linker").css("display", "none"), $("#linkershort").css("display", "flex"), $(".backpage").css("display", "grid")) : ($(".navbar").css("display", "block"), $(".backpage,#linkershort").css("display", "none"), $("#linker,.loaderback").css("display", "flex")), setTimeout(() => {
        $(".loaderback").fadeOut()
    }, 500);
    let e = new Date;
    ...
    }), notifs = document.getElementById("notifbar"), $("#home").click(function() {
        notifs.classList.add("active"), r.classList.remove("active"), s.classList.remove("active"), $("#backcloser").fadeOut(), document.body.classList.remove("static"), c.classList.remove("active"), o.classList.remove("active")
