$(document).ready(function(){
    ...
    function scrollFunction(){
        if(document.body.scrollTop>50||document.documentElement.scrollTop>50){navbar.classList.remove('active')}
        else{navbar.classList.add('active')}
    };
    let topscroll=document.querySelector('#top');
    window.onscroll=function(){scrollFunction()};
    function scrollFunction(){
        if(document.body.scrollTop>700||document.documentElement.scrollTop>700){topscroll.classList.add('active')}
        else{topscroll.classList.remove('active')}
    };
