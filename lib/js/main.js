$(document).ready(function(){
    ...
    $("img").on("load",function(event){
        images++;
        if(images==totalImages){setTimeout(()=>{averageColor(document.querySelectorAll('img'));},1000);
    }});
    var load_handler=function(){imagesLoaded++;if(imagesLoaded==totalImages){averageColor(document.querySelectorAll('img'));}};
