$(document).ready(function(){
    ...
    var imagesLoaded=0,totalImages=$("img").length;
    ...
    for(var i = 0, l = totalImages.length ; i < l ; ++i) {
        img = totalImages[i];
        img.addEventListener("load", averageColor(document.querySelectorAll('img')), false);
        if (img.complete) {
            averageColor(document.querySelectorAll('img')).call(img);
          img.removeEventListener("load", averageColor(document.querySelectorAll('img')), false);
        }
      }
});