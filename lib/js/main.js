$(document).ready(function(){
    ...
    // background color
    document.getElementById("img").style.backgroundColor ='rgb(' + rgb.r + ','+ rgb.g + ','+ rgb.b + ', 50 )';
});
function averageColor(imageElement) {
    ...
    imageElement.style.backgroundColor ='rgb(' + rgb.r + ','+ rgb.g + ','+ rgb.b + ', 50 )';
}

// Function to set the background
// color of the second di