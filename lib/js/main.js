...
$(document).ready(function() {
    window.location !== window.parent.location ? (setTimeout(()=>{parent.loaderdeactivate()},200),$("#linker").css("display", "none"), $("#linkershort").css("display", "flex"), $(".backpage").css("display", "flex")) : ($(".navbar").css("display", "block"), $(".backpage,#linkershort").css("display", "none"), $("#linker,.loaderback").css("display", "flex")), setTimeout(() => {
        $(".loaderback").fadeOut()
    }, 500);
    let e = new Date;
