...
function averageColor(imageElement) {
    ...
    height = canvas.height =
        imageElement[j].naturalHeight ||
        imageElement[j].offsetHeight ||
        imageElement[j].height;
    width = canvas.width =
        imageElement[j].naturalWidth ||
        imageElement[j].offsetWidth ||
        imageElement[j].width;
    ...
    imageElement[j].style.backgroundColor ='rgb(' + rgb.r + ','+ rgb.g + ','+ rgb.b + ', 80 )';
